...
<html>
	...
	<body>
		...
		<table border="1" width="600">
			...
			<tr>
				<td><a href="/mybatis/product/detailViewProduct/${prd.prdNo}">${prd.prdNo}</a></td>
				<td>${prd.prdName}</td>
				<td>${prd.prdPrice}</td>
				<td>${prd.prdCompany}</td>
				<td>${prd.prdStock}</td>
				<td><fmt:formatDate value="${prd.prdDate}" pattern="YYYY-MM-dd"/></td>
				<td><img src="<c:url value='/prd_images/${prd.prdNo}.jpg'/>" alt="${prd.prdName}" width="30" height="30"/></td>
			</tr>
			</c:forEach>						
		</table><br><br>
